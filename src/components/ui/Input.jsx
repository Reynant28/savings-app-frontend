      ...
      <div className="relative">
        ...
        {showPasswordToggle && (
          <button
            ...
            className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600 rounded-full focus:outline-gray-300/50 focus:outline-2 focus:outline-offset-2 drop-shadow-lg transition-colors"
          >
